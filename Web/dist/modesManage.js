...
var _socketio = _interopRequireDefault(require("../socketio.js"));
...
var Modes = /*#__PURE__*/function () {
  ...
  _createClass(Modes, [{
    key: "askThermostat",
    value: function askThermostat() {
      var command = 'nrf24/node/2Nodw/ther/get/mode/254/';

      _socketio["default"].socket.emit("command", command);
    }
  }, {
    key: "init",
    value: function init() {
      ...
      _socketio["default"].socket.on("messageConsole", function (data) {
        ...
        _this.checkState().then(function (modes) {
          ...
          var _iterator = _createForOfIteratorHelper(modes),
              _step;
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              ...
              var _iterator2 = _createForOfIteratorHelper(dataModes),
                  _step2;
...
var SocketIOManage = /*#__PURE__*/function () {
  function SocketIOManage(io, address, port) {
    _classCallCheck(this, SocketIOManage);
  ...
  _createClass(SocketIOManage, [{
    ...
    key: "initReceive",
    value: function initReceive() {
      var ioconnectionId = $('#ioconnection');
      this.socket.on('messageConsole', function (message) {
