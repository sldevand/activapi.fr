...
class ThermostatManagerPDO extends Manager{

  public function count(){
    return $this->dao->query('SELECT COUNT(*) FROM thermostat')->fetchColumn();
  }
  ...
  public function getList(){
    ...
    foreach ($listeThermostat as $key => $thermostat) {
     ...
     if(!is_bool($mode)) $thermostat->setMode($mode);
     if(!is_bool($sensor))  $thermostat->setSensor($sensor);
    }
